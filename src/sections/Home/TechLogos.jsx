          ...
          <div key={index} className="mb-12">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-6">
              {rotatingLogos[category].map((logo, logoIndex) => (
                <div
                  key={logoIndex}
                  className="flex justify-center items-center p-6 bg-white dark:bg-background-dark-light border border-grey-400 dark:border-grey-700 shadow-lg rounded-xl transition-all duration-500 transform hover:scale-110 hover:shadow-2xl hover:rotate-2"
                  style={{
